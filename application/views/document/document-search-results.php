<div class="row">
	      ...
	      <table class="table table-bordered">
	        <thead>
	          <tr>
	            ...
	            <th><span class="glyphicon glyphicon-eye-open"></span> Viewable</th>
	        	...
	        	<?php
	        		...
	        		foreach($results as $result){
						...
						if($allowed == 0){
							...
							$allowed_label = '<span class="glyphicon glyphicon-remove bg bg-green"></span> No';
						}else{
						...
						<tr>
				           ...
				           <td><?php echo $code; ?></td>
				           <td><?php echo $name; ?></td>
				           <td class="text-center text-success"><?php echo $allowed_label; ?></td>
				           <td>
				           	...
				           	<a <?php echo $disabled; ?> class="btn btn-danger" data-toggle="tooltip" data-placement="top" title="Delete" href="<?php echo base_url($document_type.'/delete/'.$id); ?>"><span class="glyphicon glyphicon-trash"></span></a>
				           </td>
				        </tr>
    ...
    <?php else: ?>
    	<div class="row">
    		<div class="col-xs-12">
    			<p>There are no records found. Please make sure to search for completed casefiles.</p>
    		</div>
    	</div>
    <?php endif; ?> 
			</div>
