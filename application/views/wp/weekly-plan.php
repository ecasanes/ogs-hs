        ...
        <div class="row custom-tooltip-container step-tooltip">
            ...
            <div class="col-xs-12">
                <div class="page-header">
                  <div class="row">
                    <div class="col-sm-4">
                      <h2 class="step-title align-title">Weekly Plan </h2>
                    </div>
                    <div class="col-sm-8">
                      <a class="btn btn-primary pull-right create-weekly-plan"><span class="glyphicon glyphicon-plus"></span> Create New Weekly Plan</a>
                    </div>
                  </div>
