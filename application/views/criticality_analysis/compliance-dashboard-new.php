...
<div class="panel panel-info collapsed">
  <div class="panel-heading">
    <h4 class="panel-title">Filter Compliance Dashboard</h4>
...
<div class="panel panel-default">
  <div class="panel-heading">
    <h4 class="panel-title">Compliance Dashboard</h4>
    <div class="panel-options">
  ...
  <div class="panel-body">
    ...
    <div id="compliance-dashboard" class="row-table table-responsive sife">
      <table  class="table table-bordered my-account table-condensed">
        <thead>
          <tr>
