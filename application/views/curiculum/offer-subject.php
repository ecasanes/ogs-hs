                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="section col-sm-2 col-xs-12">
                                <div class="loading hidden"><i class="fa fa-loading fa-spin"></i> Loading Sections...
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="subject col-sm-2 col-xs-12">
                                <div class="loading hidden"><i class="fa fa-loading fa-spin"></i> Loading Subjects...
                                </div>
            ...
            <div id="search-offered-subjects" class="panel-body">
                <div class="form-horizontal">
                    <div class="row">
                        ...
                        <div class="form-group">
                            <label for="school_year" class="control-label col-sm-2 col-xs-12">Filter by School
                                Year</label>
