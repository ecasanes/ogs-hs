<div class="panel panel-default">
	...
	<div class="panel-heading">
		<h4 class="panel-title"><?php echo $step_title; ?> <i class="fa fa-question-circle text-success basic-popover"></i></h4>
	...
	<div class="panel-body">
        ...
        <div class="row">
            <label class="control-label col-sm-2 col-xs-12 required-input">Justification for Defect Elimination:</label>
        ...
        <div class="row">
            ...
            <label class="col-xs-12 col-sm-2 control-label">Document Code:</label>
            <div class="col-xs-12 col-sm-4">
                <div class="form-group">
        ...
        <div class="row">
            ...
            <label class="control-label col-xs-12 col-sm-2">Date of Issue:</label>
            <div class="col-xs-12 col-sm-4">
                <div class="form-group">
