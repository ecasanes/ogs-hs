<?php
	...
	$edit_step_0_title = array('title' => 'Edit ERP');
	$edit_step_1_title = array('title' => 'Edit ERP Status');
	$edit_step_2_title = array('title' => 'Edit Message Board');
	$edit_step_3_title = array('title' => 'Edit Repair Report');
	$edit_step_4_title = array('title' => 'Edit Observations and Recommendations');
...
<div class="panel panel-default">
	<div class="panel-heading">
		<h4 class="panel-title">Equipment Repair</h4>
	</div>
	...
	<div class="panel-body">
		...
		<div class="row">
			<div class="col-xs-12">
				<div class="page-header">
					<div class="row">
						<div class="col-xs-3">
							<h4 class="visible-print content-title">Profile</h4>
						</div>
		...
		<br>
		<h4 class="content-title hidden-print">User Profile</h4>
		...
		<h4 class="content-title">Responsible Parties</h4>
		<div class="row-table table-responsive">
				<table class="table table-bordered view-casefile">
					<tbody>
						<tr>
		...
		<h4 class="content-title">Interested Parties</h4>
		<div class="row-table table-responsive">
				<table class="table table-bordered view-casefile">
					<tbody>
						<tr>
		...
		<div class="row print-break">
			<div class="col-xs-12">
				<div class="page-header">
					<div class="row">
						<div class="col-xs-5">
							<h4 class="content-title">Step 1 - Status</h4>
						</div>
		...
		<div class="row-table table-responsive">
			...
			<div class="row print-break">
				<div class="col-xs-12">
					...
					<div class="row">
						<div class="col-xs-5">
							<h4 class="content-title">Step 2 - Message Board</h4>
						</div>
						<div class="col-xs-7 text-right">
		...
		<div class="row-table table-responsive">
			...
			<div class="row print-break">
				<div class="col-xs-12">
					...
					<div class="row">
						<div class="col-xs-6">
							<h4 class="content-title">Step 3 - Repair Report</h4>
						</div>
		...
		<div class="row-table table-responsive">
			...
			<h4 class="content-title">Responsible Party</h4>
                ...
                if($current_question != $previous_question){
                    ?>
                    	...
                    	<?php if($current_question == 'Maintenance'): ?>
							<div class="row print-break">
                        		<div class="col-xs-5">
                        			<h4 class="content-title"><?php echo $current_question; ?></h4>
                        		</div>
                        		<div class="col-xs-7 text-right">
			...
			<div class="row print-break">
				<div class="col-xs-12">
					...
					<div class="row">
						<div class="col-xs-7">
							<h4 class="content-title">Step 4 - Observations and Recommendations</h4>
						</div>
