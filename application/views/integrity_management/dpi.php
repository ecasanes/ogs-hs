...
<div class="panel panel-info collapsed">
    <div class="panel-heading">
        <h4 id="inspection_title" class="panel-title">Dye Penetrant Inspection Report</h4>
...
<div class="row-content">
	<div class="col-xs-12" style="margin-left: 30px;">
		<div class="col-xs-6">
			<div class="col-xs-6">
				<label for="" class="col-sm-12 col-xs-12 control-label">Penetrant Type:</label>
				<div class="col-sm-12 col-xs-12">
					<div class="form-group">
	                    <input type="text" class="form-control" name="location" id="" placeholder="" value="">
	                </div>
				</div>
				<label for="" class="col-sm-12 col-xs-12 control-label">Visible:</label>
				<div class="col-sm-12 col-xs-12">
					<div class="form-group">
	                    <input type="text" class="form-control" name="location" id="" placeholder="" value="">
	                </div>
				</div>
				<label for="" class="col-sm-12 col-xs-12 control-label">Fluorescent:</label>
				<div class="col-sm-12 col-xs-12">
					<div class="form-group">
	                    <input type="text" class="form-control" name="location" id="" placeholder="" value="">
	                </div>
			...
			<div class="col-xs-6">
				<label for="" class="col-sm-12 col-xs-12 control-label">Water Washable:</label>
				<div class="col-sm-12 col-xs-12">
					<div class="form-group">
	                    <input type="text" class="form-control" name="location" id="" placeholder="" value="">
	                </div>
				</div>
				<label for="" class="col-sm-12 col-xs-12 control-label">Removable:</label>
				<div class="col-sm-12 col-xs-12">
					<div class="form-group">
	                    <input type="text" class="form-control" name="location" id="" placeholder="" value="">
	                </div>
				</div>
				<label for="" class="col-sm-12 col-xs-12 control-label">Batch No 1:</label>
				<div class="col-sm-12 col-xs-12">
					<div class="form-group">
	                    <input type="text" class="form-control" name="location" id="" placeholder="" value="">
	                </div>
		...
		<div class="col-xs-6">
			<div class="col-xs-6">
				<label for="" class="col-sm-12 col-xs-12 control-label">Developer:</label>
				<div class="col-sm-12 col-xs-12">
					<div class="form-group">
	                    <input type="text" class="form-control" name="location" id="" placeholder="" value="">
	                </div>
			...
			<div class="col-xs-6">
				<label for="" class="col-sm-12 col-xs-12 control-label">Remover:</label>
				<div class="col-sm-12 col-xs-12">
					<div class="form-group">
	                    <input type="text" class="form-control" name="location" id="" placeholder="" value="">
	                </div>
...
<div class="row-content">
    <label for="" class="col-sm-2 col-xs-12 control-label">Penetrant Dwell Time:</label>
	<div class="col-sm-4 col-xs-12">
		<div class="form-group">
            <input type="text" class="form-control" name="customer" id="" placeholder="" value="">
        </div>
	...
	<label for="" class="col-sm-2 col-xs-12 control-label">Light Type:</label>
	<div class="col-sm-4 col-xs-12">
		<div class="form-group">
            <input type="text" class="form-control" name="location" id="" placeholder="" value="">
        </div>
	...
	<label for="" class="col-sm-2 col-xs-12 control-label">Developer Dwell Time:</label>
	<div class="col-sm-4 col-xs-12">
		<div class="form-group">
            <input type="text" class="form-control" name="location" id="" placeholder="" value="">
        </div>
	...
	<label for="" class="col-sm-2 col-xs-12 control-label">Acceptance Standard/Code:</label>
	<div class="col-sm-4 col-xs-12">
		<div class="form-group">
            <input type="text" class="form-control" name="location" id="" placeholder="" value="">
        </div>
