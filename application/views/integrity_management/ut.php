<!-- Corrosion Modal -->
<div class="modal fade" id="corrosion" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
...
<div class="row">
    <div class="col-sm-2 col-xs-12" style="margin-left: 13px; margin-bottom: 20px;">
        <button type="button" class="btn btn-info" data-toggle="modal" data-target="#corrosion"><i class="fa fa-plus"></i> Add Corrosion</button>
    </div>
...
<div class="panel panel-info collapsed">
    <div class="panel-heading">
        <h4 id="inspection_title" class="panel-title">Ultrasonic Inpsection</h4>
    ...
    <div class="panel-body">
       <div class="row-content">
			...
			<div class="col-sm-4 col-xs-12">
				<div class="form-group">
	                <input type="text" class="form-control" name="customer" id="" placeholder="" value="">
	            </div>
			</div>
			...
			<div class="col-sm-4 col-xs-12">
				<div class="form-group">
	                <input type="text" class="form-control" name="location" id="" placeholder="" value="">
	            </div>
			</div>
			...
			<label for="" class="col-sm-2 col-xs-12 control-label">Model:</label>
			<div class="col-sm-4 col-xs-12">
				<div class="form-group">
	                <input type="text" class="form-control" name="location" id="" placeholder="" value="">
	            </div>
			...
			<label for="" class="col-sm-2 col-xs-12 control-label">Serial No:</label>
			<div class="col-sm-4 col-xs-12">
				<div class="form-group">
	                <input type="text" class="form-control" name="location" id="" placeholder="" value="">
	            </div>
			...
			<label for="" class="col-sm-2 col-xs-12 control-label">Couplant:</label>
			<div class="col-sm-4 col-xs-12">
				<div class="form-group">
	                <input type="text" class="form-control" name="location" id="" placeholder="" value="">
	            </div>
	...
	<div class="row-content">
	    <label for="" class="col-sm-2 col-xs-12 control-label">Probe Type:</label>
		<div class="col-sm-4 col-xs-12">
			<div class="form-group">
	            <input type="text" class="form-control" name="customer" id="" placeholder="" value="">
	        </div>
		...
		<label for="" class="col-sm-2 col-xs-12 control-label">Probe Angle:</label>
		<div class="col-sm-4 col-xs-12">
			<div class="form-group">
	            <input type="text" class="form-control" name="location" id="" placeholder="" value="">
	        </div>
		...
		<label for="" class="col-sm-2 col-xs-12 control-label">Crystal Size:</label>
		<div class="col-sm-4 col-xs-12">
			<div class="form-group">
	            <input type="text" class="form-control" name="location" id="" placeholder="" value="">
	        </div>
		...
		<label for="" class="col-sm-2 col-xs-12 control-label">Frequency</label>
		<div class="col-sm-4 col-xs-12">
			<div class="form-group">
	            <input type="text" class="form-control" name="location" id="" placeholder="" value="">
	        </div>
		...
		<label for="" class="col-sm-2 col-xs-12 control-label">Primary Sensitivity:</label>
		<div class="col-sm-4 col-xs-12">
			<div class="form-group">
	            <input type="text" class="form-control" name="location" id="" placeholder="" value="">
	        </div>
		...
		<label for="" class="col-sm-2 col-xs-12 control-label">Transfer Correction:</label>
		<div class="col-sm-4 col-xs-12">
			<div class="form-group">
	            <input type="text" class="form-control" name="location" id="" placeholder="" value="">
	        </div>
		...
		<label for="" class="col-sm-2 col-xs-12 control-label">Calibration Block:</label>
		<div class="col-sm-4 col-xs-12">
			<div class="form-group">
	            <input type="text" class="form-control" name="location" id="" placeholder="" value="">
	        </div>
		...
		<label for="" class="col-sm-2 col-xs-12 control-label">Heat Treatment:</label>
		<div class="col-sm-4 col-xs-12">
			<div class="form-group">
	            <input type="text" class="form-control" name="location" id="" placeholder="" value="">
	        </div>
		...
		<label for="" class="col-sm-2 col-xs-12 control-label">Reference Block:</label>
		<div class="col-sm-4 col-xs-12">
			<div class="form-group">
	            <input type="text" class="form-control" name="location" id="" placeholder="" value="">
	        </div>
		...
		<label for="" class="col-sm-2 col-xs-12 control-label">Block Thickness:</label>
		<div class="col-sm-4 col-xs-12">
			<div class="form-group">
	            <input type="text" class="form-control" name="location" id="" placeholder="" value="">
	        </div>
		...
		<label for="" class="col-sm-2 col-xs-12 control-label">Hole/Notch Size:</label>
		<div class="col-sm-4 col-xs-12">
			<div class="form-group">
	            <input type="text" class="form-control" name="location" id="" placeholder="" value="">
	        </div>
		...
		<label for="" class="col-sm-2 col-xs-12 control-label">Sensitivity Setting-Comp:</label>
		<div class="col-sm-4 col-xs-12">
			<div class="form-group">
	            <input type="text" class="form-control" name="location" id="" placeholder="" value="">
	        </div>
		...
		<label for="" class="col-sm-2 col-xs-12 control-label">Sensitivity Setting-Shear:</label>
		<div class="col-sm-4 col-xs-12">
			<div class="form-group">
	            <input type="text" class="form-control" name="location" id="" placeholder="" value="">
	        </div>
		...
		<label for="" class="col-sm-2 col-xs-12 control-label">Time-Base Range Comp:</label>
		<div class="col-sm-4 col-xs-12">
			<div class="form-group">
	            <input type="text" class="form-control" name="location" id="" placeholder="" value="">
	        </div>
		...
		<label for="" class="col-sm-2 col-xs-12 control-label">Time-Base Range Shear:</label>
		<div class="col-sm-4 col-xs-12">
			<div class="form-group">
	            <input type="text" class="form-control" name="location" id="" placeholder="" value="">
	        </div>
	...
	<div class="row-content">
		<label for="" class="col-sm-2 col-xs-12 control-label">Technique:</label>
		<div class="col-sm-4 col-xs-12">
			<div class="form-group">
	            <input type="text" class="form-control" name="location" id="" placeholder="" value="">
	        </div>
		...
		<label for="" class="col-sm-2 col-xs-12 control-label">Acceptance Standard:</label>
		<div class="col-sm-4 col-xs-12">
			<div class="form-group">
	            <input type="text" class="form-control" name="location" id="" placeholder="" value="">
	        </div>
		...
		<label for="" class="col-sm-2 col-xs-12 control-label">Size:</label>
		<div class="col-sm-4 col-xs-12">
			<div class="form-group">
	            <input type="text" class="form-control" name="location" id="" placeholder="" value="">
	        </div>
		...
		<label for="" class="col-sm-2 col-xs-12 control-label">Identification:</label>
		<div class="col-sm-4 col-xs-12">
			<div class="form-group">
	            <input type="text" class="form-control" name="location" id="" placeholder="" value="">
	        </div>
	    ...
	    <div class="col-xs-12">
	        ...
	        <div class="col-xs-12">
	            <div class="form-group form-group-required">
	                <textarea class="form-control textarea-editor medium" name="relevance"></textarea>
	            </div>
	        </div>

	        <div class="col-xs-12">
	            <div class="page-header">
	                <h4 class="step-title">Restrictions/Extent of Inspection:</h4>
	            </div>
	        </div>
