<div class="panel panel-default">
	...
	<div class="panel-heading">
		<h4 class="panel-title"><?php echo $step_title; ?> <i class="fa fa-question-circle text-success step1-popover"></i></h4>
	</div>
  ...
  <div class="row">
    <div class="col-xs-12">
      <div class="form-group">
        <textarea rows="6" class="form-control textarea-editor medium" name="summary"><?php echo $summary; ?></textarea>
      </div>
    </div>
  </div>
  ...
  <div class="row">
    <div class="col-xs-12">
      <div class="page-header">
        <h4 class="step-title">Timeline <i class="fa fa-question-circle text-success timeline-basic-popover"></i></span></h4>
      </div>
    </div>
  </div>
    ...
    <div id="consequence-table">
      ...
      <input type="hidden" value="<?php echo $detection_details; ?>" name="detection_details">
          ...
          <div id="failure-mode-tooltip">
            ...
            <div class="row">
              <label for="failure_description" class="control-label col-xs-12 col-sm-2 required-input">Description </label>
