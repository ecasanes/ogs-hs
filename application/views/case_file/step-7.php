<div class="panel panel-default">
	...
	<div class="panel-heading">
		<h4 class="panel-title"><?php echo $step_title; ?> <i class="fa fa-question-circle text-success cf-step6-popover"></i></h4>
	</div>
              ...
              <div class="page-header">
                  <div class="row">
                      <div class="col-xs-12 col-sm-8">
                          <h4 class="step-title">Summary of Results <span class="text-required">*</span></h4>
                      </div>
