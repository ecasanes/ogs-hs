    ...
    <div class="panel-body">
        ...
        <fieldset>
            ...
            <div class="row">
                ...
                <label class="control-label col-sm-1 col-xs-12 required-input">Date:</label>
                ...
                <label class="control-label col-sm-2 col-xs-12 required-input">Name:</label>
                <div class="col-xs-12 col-sm-4">
                    <div class="form-group">
                ...
                <label class="control-label col-sm-1 col-xs-12">Number:</label>
                <div class="col-xs-12 col-sm-5">
                    <div class="form-group">
                ...
                <label class="control-label col-sm-2 col-xs-12">Enable Additional Contributors:</label>
        ...
        <fieldset>
            ...
            <div class="row">
                ...
                <label class="control-label col-sm-2 col-xs-12 required-input">Date of Issue:</label>
                <div class="col-xs-12 col-sm-4">
                    <div class="form-group">
                ...
                <label class="control-label col-sm-2 col-xs-12 required-input">Area of Focus:</label>
                <div class="col-xs-12 col-sm-4">
                    <div class="form-group">
                        <select class="form-control" name="area_of_focus" id="area_of_focus" required>
                            <?php echo $area_of_focus; ?>
                        </select>
                    </div>
                </div>

                <!-- experimental file manager -->
                <label class="control-label col-sm-2 col-xs-12">Files:</label>
                <div class="col-xs-12 col-sm-4">
                    <div class="form-group">
                        <input type="text" id="" name="test" class="form-control display-file-manager" placeholder="File" value="">
                    </div>
                </div>
        ...
        <fieldset><!-- 
            <div class="page-header">
                <h4>Equipment Profile <i class="fa fa-question-circle text-success equipment_profile-popover"></i></h4>
            </div>
            <div class="row content">
                                ...
                                <div class="row content">
                                    <label class="col-sm-2 col-xs-12 control-label" for="system">Description </label>
                                    <div class="col-sm-4 col-xs-12">
                                        <div class="form-group">
                                ...
                                <div class="row content">
                                    <label class="col-sm-2 col-xs-12 control-label" for="system">Code </label>
                                    <div class="col-sm-4 col-xs-12">
                                        <div class="form-group">
                                            <div class="form-group">
        ...
        <div class="row content">
            ...
            <div class="col-xs-12 col-sm-4">
                <div class="form-group">
                    <input type="text" class="form-control" name="equipment_power_output" id="equipment-power-output" placeholder="optional" value="<?php echo $equipment_power_output; ?>">
                </div>
            </div>
        </div>
        <div class="row content">
            ...
            <div class="col-xs-12 col-sm-4">
                <div class="form-group">
                    <input type="text" class="form-control" name="equipment_tag_number" id="equipment-tag-number" placeholder="optional" value="<?php echo $equipment_tag_number; ?>">
                </div>
            </div>
        </div>
        <div class="row content">
            ...
            <div class="col-xs-12 col-sm-4">
                <div class="form-group">
                    <input type="text" id="equipment-unique-id" name="equipment_unique_id" class="form-control" placeholder="optional" value="<?php echo $equipment_unique_id; ?>">
                </div>
            </div>
        </div>
        <div class="row content">
            ...
            <div class="col-xs-12 col-sm-4">
                <div class="form-group">
                    <input type="text" class="form-control" name="equipment_manufacturer" id="equipment-manufacturer" placeholder="optional" value="<?php echo $equipment_manufacturer; ?>">
                </div>
            </div>
        </div>
        <div class="row content">
            ...
            <div class="col-xs-12 col-sm-4">
                <div class="form-group">
                    <input type="text" id="equipment-model" name="equipment_model" class="form-control" placeholder="optional" value="<?php echo $equipment_model; ?>">
                </div>
            </div>
        </div>
        <div class="row content">
            ...
            <div class="col-xs-12 col-sm-4">
                <div class="form-group">
                    <input type="text" id="equipment-failed-component" name="equipment_failed_component" class="form-control" placeholder="optional" value="<?php echo $equipment_failed_component; ?>">
                </div>
            </div>
        </div>
