...
class General_Inspection extends MY_Controller {

	public function __construct(){

	     parent::__construct();

	    $this->document_code = 'GIP';
	    $this->document_primary = 'document_id';
	    $this->form_primary = 'id';

	    $main_model_str = 'General_Inspection_Model';
	...
	public function add()
	{
		...
		if($data){
			...
			$this->load->model('General_Inspection');
			$general_inspection_modal = new General_Inspection_Model();

			// Isolate and clean data.
			$report_no = $this->input->post();
			$customer = $this->input->post();
			$location = $this->input->post();
			$procedure = $this->input->post();
			$project = $this->input->post();
			$surface = $this->input->post();
			$equiptment = $this->input->post();
			$equiptment_serial_no = $this->input->post();
			$type_of_inspection = $this->input->post();
			$item = $this->input->post();
			$drawing_no = $this->input->post();
			$specification = $this->input->post();
			$material = $this->input->post();
			$size = $this->input->post();
			$quantity = $this->input->post();
			$scope = $this->input->post();
			$extent_of_inspection = $this->input->post();
			$results = $this->input->post();
			$inspection = $this->input->post();
			$date = $this->input->post();
			$for_client_use = $this->input->post();
			$for_cert_auth = $this->input->post();
		}
