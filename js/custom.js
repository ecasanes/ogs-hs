...
function get_action_tracker_list(){
                ...
                if(table_data.length < 1){
                    ...
                    $.each(table_data, function(index, item) {
                        ...
                        var row_table = '<tr class="data-row">';
                            ...
                            //document
                            row_table += '<td class="doc-code"><select name="document_id" class="table-select">';
                            ...
                            //owner
                            row_table += '<td><select name="owner" id="document_name" class="table-select select2-dropdown">'; 
                        ...
                        $.each(subaction_data, function(index, sub) {
                            ...
                            var sub_row_table = '<tr class="subaction-data-row">';
                                ...
                                sub_row_table += '<td class="subaction-doc-code"><select name="document_id" class="table-select">';
                                ...
                                sub_row_table += '<td class="subaction-owner"><select name="owner" id="document_name" class="table-select select2-dropdown">'; 
    ...
    $(document).on('click', '.add-subaction-tracker', function(e) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                subaction_row += '<td class="subaction-doc-code"><select class="table-select">'+document_html+'</select></td>';
                ...
                subaction_row += '<td class="subaction-owner"><select class="table-select" name="owner" >'+owner_html+'</select></td>';
...
function get_menu_list()
{
   ...
   /* $.ajax({
        type: "get",
        url: base_url+'user/ajax_menu_list',
        dataType: 'html',
        success: function(data){
