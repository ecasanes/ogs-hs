        ...
        Plugin.prototype = {
                ...
                moveDown: function() {
                        if (!this.moving) {
                                ...
                                this.$el.children('.ticker-row:last').detach().prependTo(this.$el).css('marginTop', '-' + this.options.row_height + 'px')
                ...
                moveUp: function() {
                        if (!this.moving) {
                                ...
                                var element = this.$el.children('.ticker-row:first');
                ...
                add: function(content){
                    this.$el.append($('<div class="row ticker-row">').html(content));
                },
