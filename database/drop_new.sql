...
ALTER TABLE `action_tracker` DROP FOREIGN KEY `critical_equipment_action_tracker`;
...
ALTER TABLE `critical_equipment` DROP FOREIGN KEY `load_file_critical_equipment`;
...
ALTER TABLE `ca_role` DROP FOREIGN KEY `critical_equipment_ca_role`;

ALTER TABLE `ca_q_category_answer` DROP FOREIGN KEY `ca_question_category_ca_q_category_answer`;

ALTER TABLE `ca_q_category_answer` DROP FOREIGN KEY `critical_equipment_ca_q_category_answer`;
...
ALTER TABLE `load_file` MODIFY `load_file_id` INTEGER(11) NOT NULL;

# Drop constraints #

ALTER TABLE `load_file` DROP PRIMARY KEY;
